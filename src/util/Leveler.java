...
public class Leveler
{
	...
	public static LevelState getLevel(int level)
	{
		...
		case 2:
			// gilbert
			gilbs = new Gilbert(620, 360, 1, 1, 0, 0);
		...
		case 4:
			// gilbert
			gilbs = new Gilbert(800, 600, 2, 0, 0, 0);
		...
		case 7:
			...
			// collectable
			collect = new Collectable(Collectable.makePoints(MID_X, MID_Y, EIGHTH2_X, EIGHTH2_Y, MID_X, MID_Y));

			return new LevelState(gilbs, planetsArray, collect);
		case 8:
			// gilbert
			gilbs = new Gilbert(800, 550, 2, 1, 0, 0);
